...
当前配置文件的版本是 `21.9.15`，兼容的 macOS 系统版本如下表所示：
...
| 12 Monterey | ✅ | ✅ | ✅ | 12.0 Beta 5 (21A5304g) | 测试版，系统存在 BUG；尝鲜请注意备份重要数据 |
...
- 引导程序为 OpenCore 0.7.3，支持引导 macOS 和 Windows；若需要引导其他操作系统需自行添加。
